          ...
          >
            ...
            <div className="space-y-10 px-0 md:px-10 max-w-6xl">
              ...
              <p className="text-lg text-center md:text-left">
                ...
                voluptatibus, quae, quia, voluptatem voluptatum quod quibusdam a
                aut quos dolorum voluptates doloremque. Quis voluptatibus, quae,
                quia, voluptatem voluptatum quod quibusdam a aut quos dolorum
